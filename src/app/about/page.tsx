...
import { Heart, Target, Lightbulb, ChefHat } from "lucide-react";
    ...
    <div className="flex flex-col w-full -mt-24">
      ...
      <section className="relative h-[400px] flex items-center justify-center overflow-hidden pt-24">
        ...
        <div className="container relative z-20 px-4 text-center">
          ...
          >
            <h1 className="font-heading text-5xl md:text-7xl font-bold text-white mb-4">Our Story</h1>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            >
              ...
              <h3 className="font-heading text-4xl md:text-5xl font-bold text-foreground">House of Hunger</h3>
        ...
        <div className="container mx-auto px-4 md:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <motion.div
              ...
              viewport={{ once: true, margin: "-100px" }}
              className="bg-background p-10 rounded-2xl border border-border relative overflow-hidden group"
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-heading font-bold text-foreground mb-4">Our Mission</h3>
                <p className="text-muted-foreground text-lg leading-relaxed">
            ...
            >
              ...
              <div className="relative z-10">
                ...
                <h3 className="text-3xl font-heading font-bold text-foreground mb-4">Our Vision</h3>
                <p className="text-muted-foreground text-lg leading-relaxed">
      ...
      <section className="py-24 bg-background">
        <div className="container mx-auto px-4 md:px-8 text-center">
          ...
          >
            ...
            <h3 className="font-heading text-4xl md:text-5xl font-bold text-foreground">Our Premium Ambience</h3>
          </motion.div>
