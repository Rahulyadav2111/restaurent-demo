...
export default function MapComponent() {
  return (
    <div className="relative w-full h-full rounded-2xl shadow-[0_10px_40px_-10px_rgba(0,0,0,0.1)] border border-border overflow-hidden z-0">
      <iframe 
      ...
      <a
        ...
        className="absolute bottom-4 right-4 bg-primary text-white p-3 rounded-full shadow-lg hover:bg-primary/90 hover:scale-110 transition-all flex items-center justify-center z-10"
